...
.background {
	background-image: url("https://cdn.pixabay.com/photo/2017/01/11/22/06/paddleboarding-1973035__340.jpg");
	background-size:100%;
}
...
<%@ include file="header.jsp" %>
  <h3>Please Enter the Correct Detials!</h3>
...
<br>
	   ...
	   <table  cellspacing="10" cellpadding="2" width="45%" 
			align="center">
<tr>
<td style="color:black;font-weight: bold;font-family: monotype corsiva;font-size: 1.5em;" > User Name<p></td>
