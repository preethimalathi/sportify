...
<body>
	...
	<header>
		<center>
		<h1 style="font-family:monotype corsiva;"><img src="/image/logo.JPG" height="77" width="77" style="font-family: monotype corsiva;" /><b>Sportify</b></h1>
	</center>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
      ...
      */
      $scope.removeItemFromCart = function (cartItemId) {
    	 ...
    	 //http://localhost:9090/sportifyUI/cart/removeItem/
         $http['delete']('http://localhost:9090/sportifyUI/categoryDropdown/productDisplay/usercart/cart/removeItem/'+ cartItemId).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:9090/sportifyUI/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:9090/sportifyUI/categoryDropdown/productDisplay/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:9090/sportifyUI/categoryDropdown/productDisplay/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
